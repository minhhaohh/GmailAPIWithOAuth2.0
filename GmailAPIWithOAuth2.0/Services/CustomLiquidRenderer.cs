...
{
    public class CustomLiquidRenderer : ITemplateRenderer
    {
        private readonly IOptions<CustomLiquidRendererOptions> _options;
        private readonly LiquidParser _parser;

        public CustomLiquidRenderer(IOptions<CustomLiquidRendererOptions> options)
        {
            _options = options;
